...
class WreckrunGame {
  ...
  setupWorld(){
    ...
    this.waypoints=[[-55,-38],[0,-54],[55,-38],[66,0],[55,38],[0,54],[-55,38],[-66,0]].map(([x,z])=>new THREE.Vector3(x,0,z));this.minimapBounds={x:112,z:90};
